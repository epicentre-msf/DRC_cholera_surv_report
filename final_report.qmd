...
We evaluated which health zones currently classified by the DRC’s MoH as endemic and non endemic reported \>0 cases per week for not more than 16 weeks (concurrent with the MoH endemic health zone definition) or \>10 cases per week for not more than 24 weeks in 2025 (a definition more relevant from the MSF operational point of view). This way we could identify the non endemic health zones with prolonged transmission periods. Number of weeks with at least 1 or 10 cases per week for endemic and non endemic health zones per year were presented on a box plot.

## Code

The analyses were conducted using R v. 4.5.2 and RStudio v. 2025.09.2+418. The code used to generate this report is available in the Epicentre repository: https://github.com/epicentre-msf/epitemplates-report.
